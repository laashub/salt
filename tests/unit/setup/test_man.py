...
@pytest.mark.skip_if_binaries_missing(*KNOWN_BINARY_NAMES, check_all=False, message='virtualenv not installed')
def test_man_pages():
    '''
    ...
    with VirtualEnv() as venv:
        ...
        venv.run(venv.venv_python, 'setup.py', 'install', '--root={}'.format(rootdir), cwd=RUNTIME_VARS.CODE_DIR)
        ...
        assert not manpage_fns, 'The following manpages were not found under {}: {}'.format(
                rootdir,
