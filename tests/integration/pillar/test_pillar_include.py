...
def create_pillar_tree():
    ...
    base:
      'minion':
        ...
        - glob_include
    '''
    with pytest.helpers.temp_pillar_file('top.sls', top_contents), \
            pytest.helpers.temp_pillar_file(glob_include_fname, glob_include_contents), \
            pytest.helpers.temp_pillar_file(glob_include_a_fname, glob_include_a_contents), \
            pytest.helpers.temp_pillar_file(glob_include_b_fname, glob_include_b_contents), \
            pytest.helpers.temp_pillar_file(include_fname, include_contents), \
            pytest.helpers.temp_pillar_file(include_a_fname, include_a_contents), \
            pytest.helpers.temp_pillar_file(include_b_fname, include_b_contents):
