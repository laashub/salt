...
def salt_run_cli(salt_factories, salt_minion, salt_master):
    ...
    """
    return salt_factories.get_salt_run_cli(salt_master.config["id"], default_timeout=120)
...
class TestSaltRun(object):
    ...
    def test_salt_run_with_eauth_bad_passwd(self, salt_run_cli, saltdev_account):
        ...
        assert ret.stdout == 'Authentication failure of type "eauth" occurred for user saltdev.'
