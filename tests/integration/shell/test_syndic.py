...
class TestSaltSyndicCLI(object):
    def test_exit_status_unknown_user(self, request, salt_factories, shell_tests_salt_master):
        '''
    ...
    def test_exit_status_unknown_argument(self, request, salt_factories, shell_tests_salt_master):
        '''
