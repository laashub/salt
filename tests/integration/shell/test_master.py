...
class TestSaltMasterCLI(object):
    def test_exit_status_unknown_user(self, request, salt_factories, shell_tests_salt_master_config):
        '''
    ...
    def test_exit_status_unknown_argument(self, request, salt_factories, shell_tests_salt_master_config):
        '''
    ...
    def test_exit_status_correct_usage(self, request, salt_factories, shell_tests_salt_master_config):
        proc = salt_factories.spawn_master(
            request,
            shell_tests_salt_master_config['id'] + '-2')
