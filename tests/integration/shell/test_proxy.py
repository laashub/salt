...
@pytest.fixture(scope='module')
def shell_tests_salt_proxy_minion_config(request, salt_factories, shell_tests_salt_master):
...
class TestProxyMinion:
    ...
    def test_exit_status_no_proxyid(self, request, salt_factories, shell_tests_salt_proxy_minion_config):
        '''
    ...
    def test_exit_status_unknown_user(self, request, salt_factories, shell_tests_salt_proxy_minion_config):
        '''
    ...
    def test_exit_status_unknown_argument(self, request, salt_factories, shell_tests_salt_proxy_minion_config):
        '''
